...
### 订阅转换 
方法1: 将 [General.ini](https://raw.githubusercontent.com/Pai333/World/main/Clash/Config/Online/General.ini) 的地址 [URLEncode](多个链接用 "+" 分隔,如不行改用 "|")(https://www.urlencoder.org/)，加在 [subconverter](https://github.com/tindy2013/subconverter/blob/master/README-cn.md) 地址的 &config= 后面；<br>
